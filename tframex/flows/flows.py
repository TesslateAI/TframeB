...
from ..patterns.patterns import BasePattern, SequentialPattern, ParallelPattern, RouterPattern, DiscussionPattern
...
class Flow:
    ...
    def generate_documentation(self, app: 'TFrameXApp') -> Tuple[str, str]:
        ...
        if not TYPE_CHECKING: # Runtime imports if not already loaded by type checker
            ...
            from ..util.tools import ToolParameters, ToolParameterProperty
    ...
    def _get_tool_details_for_yaml(self, tool_name: str, app: 'TFrameXApp') -> Dict[str, Any]:
        from ..util.tools import ToolParameters, ToolParameterProperty # Ensure available at runtime
